...
public class Calculation {
    private int id;
    private String calculationStr, lastNum, lastOperator;
    ...
    public Calculation(int id, String calculationStr, String lastDigit, String lastNum, int lastNumberDecimal, double result) {
        this.id = id;
